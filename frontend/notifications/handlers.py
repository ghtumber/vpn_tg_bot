...
period_checker_scheduler.add_job(func=payment_system, day_of_week='mon-sun', trigger=CronTrigger(hour=16, minute=50, timezone="Europe/Moscow"))
print(f"payment_system will be in 16:50 Msk")
